...
$(document).ready(function () {
        ...
        columns: [
            ...
            },
            {
                ...
                cellsrenderer: function ( row,
                    ...
                    columnproperties,
                    rowdata) {
                    return `<p style="" class="text-secondary ps-1  my-auto" >${rowdata.created}</p>`;
                },
                minwidth: 170,
                filterable: false,
            },
            {
                ...
                cellsrenderer: function (row,
                    ...
                    columnproperties,
                    rowdata) {
                    return `<p class=" text-secondary ps-1  my-auto" style="" >${rowdata.members}</p>`;
                },
            },
            {
                minwidth: 120,
                ...
                cellsrenderer: function (row,
                    ...
                    columnproperties,
                    rowdata) {
                    return `<p class=" text-secondary ps-1 my-auto " style="" >${rowdata.shippingPoint}</p>`;
                },
            },
            {
                minwidth: 120,
                ...
                cellsrenderer: function (row,
                    ...
                    columnproperties,
                    rowdata) {
                    return `<p class=" text-secondary ps-1 my-auto " style="" >${rowdata.deliveryPoint}</p>`;
                },
            },
            {
                minwidth: 90,
                ...
                cellsrenderer: function (row,
                    ...
                    columnproperties,
                    rowdata) {
                    return `<p class="text-secondary  ps-1  my-auto" style="" >
                        ${rowdata.pallets}
                </p>`;
                },
            },
    ...
    let listSource = [
        {
            label: `${getLocalizedText("consolidation")}`,
            value: "id",
            checked: true,
        },
        {
            label: `${getLocalizedText("created")}`,
            value: "created",
            checked: true,
        },
        {
            label: `${getLocalizedText("particioants")}`,
            value: "members",
            checked: true,
        },
        {
            label: `${getLocalizedText("starting_point")}`,
            value: "shippingPoint",
            checked: true,
        },
        {
            label: `${getLocalizedText("end_point")}`,
            value: "deliveryPoint",
            checked: true,
        },
        {
            label: `${getLocalizedText("pallet_space")}`,
            value: "address",
            checked: true,
        },
        { label: `${getLocalizedText("actions")}`, value: "action", checked: true },
    ];
