...
$(document).ready(function () {
    ...
    var grid = table.jqxGrid(
        {
            ...
            rendertoolbar: function (statusbar) {
                ...
                return toolbarRendererLeftovers(statusbar, table, true, 1, columnCount - 1, '-log-2'); // Subtract 1 to exclude the action column
            },
            columns: [
                {
                    dataField: 'stock',
    ...
    listbox(table, listSource, '-log-2');
