...
$(document).ready(function () {
    let table = $('#updateСontainerDataTable')
    ...
    function getUrl() {
        ...
        return window.location.origin + '/document/container/table/filter?document_id=' + document_id;
    }
    ...
    var source = {
        ...
        deleteRow: async function (rowID, commit) {
            ...
            fetch(window.location.origin + '/table/container_by_document/' + rowData.id, {
                method: 'POST',
                body: formData
            }).then(() => {
                commit(true)
