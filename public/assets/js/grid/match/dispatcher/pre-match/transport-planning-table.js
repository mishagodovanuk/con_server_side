...
$(document).ready(function () {
    ...
    window.Echo.channel('reserve-transport-planning').listen("ReserveTransportPlanning", (event) => {
        let tpId = event.id
        console.log(tpId)
    });
    ...
    let table = $("#transport-planning-table");
    ...
    var myDataSource = {
        ...
        url: window.location.origin + '/match/transport-planning/filter',
        root: 'data',
