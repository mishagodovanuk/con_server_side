...
$(document).ready(function () {
    ...
    var myDataSource = {
        ...
        url: window.location.origin + `/leftovers/table/filter`,
        root: 'data',
    ...
    var grid = table.jqxGrid(
        {
            ...
            rendertoolbar: function (statusbar) {
                ...
                return toolbarRendererLeftovers(statusbar, table, true, 1, columnCount - 2); // Subtract 1 to exclude the action column
            },
            columns: [
                {
                    dataField: 'sku',
                ...
                },
                {
                    ...
                    cellsrenderer: function (row, columnfield, value, defaulthtml, columnproperties, rowdata) {
                        ...
                        return `<p class="mb-0 d-flex w-100 justify-content-start text-secondary" style="padding-left: 5px" >Всього: ${rowdata.count} ${warehousesHtml}</p>`;
                    },
                },
                {
                    width: '70px',
