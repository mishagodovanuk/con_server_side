    ...
    a.extend(a.jqx._jqxGrid.prototype, {
        _updatefilterrowui: function (f) {
            ...
            if (b.filteritems && b.filteritems.length > 0) {
                ...
                var f = new a.jqx.dataAdapter(e, {autoBind: false, async: false})
            } else {
                if (b.filteritems) {
                    ...
                    if (q.filtertype == "list" || q.filtertype == "checkedlist") {
                        ...
                        if (m) {
                            ...
                            if (b.getItem(this.gridlocalization.filterselectallstring) == null) {
                                b.insertAt({label: this.gridlocalization.filterselectallstring}, 0)
                            }
            ...
            for (var d = 0; d < f.columns.records.length; d++) {
                if (f.columns.records[d].datafield && f.columns.records[d].filterable) {
                    c.push({label: f.columns.records[d].text, value: f.columns.records[d].displayfield})
                }
            }
            ...
            if (this._hasdatefilter && (E.filtertype !== "list" && E.filtertype !== "checkedlist" && E.filtertype !== "custom")) {
                ...
                if (E.filtertype == "date") {
                    ...
                    n(b);
                    var b = a("<input autocomplete='off' class='filtertext2" + s.element.id + "' style='box-sizing: content-box; height: 16px; padding: 3px;' type='text' placeholder='Значення фільтра'></input>");
                    d.append(b);
                    n(b)
                }
                var j = g.find(".filtertext1" + s.element.id);
            ...
            if (this.filtermode === "default" && (E.filtertype !== "list" && E.filtertype !== "checkedlist" && E.filtertype !== "custom")) {
                ...
                if (this.filtermode === "excel" || E.filtertype === "list" || E.filtertype === "checkedlist") {
                    ...
                    if (L) {
                        f.jqxListBox("insertAt", {label: s.gridlocalization.filterselectallstring}, 0);
            ...
            b[0].innerHTML = "";
            var t = a("<div class='filter filter-castom' style='position: absolute; bottom: 3px; margin-left: 3px;'></div>");
            b.append(t);
            ...
            var k = a("<div style='margin-top:3px;' class='filter'><input autocomplete='off' class='filtertext1" + z.element.id + "' style='padding: 3px; height: 17px; margin-top: 3px; margin-bottom: 3px;'  type='text' placeholder='Значення фільтра'></input></div>");
            var m = k.find("input");
            m.addClass(this.toThemeProperty("jqx-input"));
            m.addClass(this.toThemeProperty("jqx-filter-input jqx-widget-content"));
            m.addClass(this.toThemeProperty("jqx-rc-all"));
            m.width(p - 18);
            var l = a("<div style='margin-top:3px;' class='filter'><input autocomplete='off' class='filtertext2" + z.element.id + "' style='padding: 3px; height: 17px; margin-top: 3px;' type='text' placeholder='Значення фільтра'></input></div>");
            var j = l.find("input");
            ...
            var g = a("<div class='filter filter-castom-button' style='height: 35px; text-align:center; margin-top: 15px; margin-left:-2px;'></div>");
            ...
            g.append(x);
            f.jqxButton({height: this.filterMenuItemsHeight, theme: z.theme});
            x.jqxButton({height: this.filterMenuItemsHeight, theme: z.theme});
            var y = function (A) {
                if (A) {
        ...
        _updatefilterrowui: function (f) {
            ...
            for (var G = 0; G < I.dataview.filters.length; G++) {
                ...
                if (y.datafield && y.datafield == D.datafield) {
                    ...
                    if (D.filtertype === "range") {
                        A = {from: A, to: y.filter.getfilters()[1].value}
                    }
                    F = G.condition;
                    D.filtercondition = F;
                    break
            ...
            switch (D.filtertype) {
                    ...
                    if (this.host.jqxDropDownList) {
                        ...
                        if (w) {
                            ...
                            if (c != undefined) {
                                ...
                                c.insertAt({label: I.gridlocalization.filterselectallstring}, 0);
                            ...
                            u.jqxDropDownList({selectedIndex: 0})
                        }
                        D._filterwidget = u;
                ...
                case"boolean":
                    if (this.host.jqxCheckBox) {
                        ...
                        if (A === true || A == "true") {
                            x.jqxCheckBox({checked: true})
                        } else {
                            if (A === false || A == "false") {
                                x.jqxCheckBox({checked: false})
                            }
                        }
                        D._filterwidget = x;
            ...
            if (this._hasdatefilter && (F.filtertype !== "list" && F.filtertype !== "checkedlist" && F.filtertype !== "custom")) {
                ...
                if (F.filtertype == "date") {
                    ...
                    d.children().remove();
                    s._showwhere.text(s.gridlocalization.filtershowrowstring);
                    var b = a("<input autocomplete='off' class='filtertext1" + s.element.id + "' style='box-sizing: content-box; height: 16px; padding: 3px;' type='text' placeholder='Значення фільтра'></input>");
                    e.append(b);
                    var n = function (c) {
                        c.addClass(s.toThemeProperty("jqx-input"));
                        c.addClass(s.toThemeProperty("jqx-filter-input jqx-widget-content"));
            ...
            if (l.length > 0) {
                l.jqxButton({height: this.filterMenuItemsHeight});
                O.jqxButton({height: this.filterMenuItemsHeight});
                this.removeHandler(l, "click");
                this.addHandler(l, "click", function () {
            ...
            if (this.filtermode === "default" && (F.filtertype !== "list" && F.filtertype !== "checkedlist" && F.filtertype !== "custom")) {
                if (f.jqxDropDownList("source") != u) {
                    f.jqxDropDownList({enableBrowserBoundsDetection: false, source: u});
                    Q.jqxDropDownList({enableBrowserBoundsDetection: false, source: u})
                }
                if (R == "boolean" || R == "bool") {
                    f.jqxDropDownList({autoDropDownHeight: true, selectedIndex: 0});
                    Q.jqxDropDownList({autoDropDownHeight: true, selectedIndex: 0})
                } else {
                    var I = false;
                    if (u && u.length) {
                        if (u.length < 5) {
                    ...
                    f.jqxDropDownList({autoDropDownHeight: I, selectedIndex: 2});
                    Q.jqxDropDownList({autoDropDownHeight: I, selectedIndex: 2})
                }
                m.jqxDropDownList({selectedIndex: 0});
                var A = F.filter;
                var N = new a.jqx.filter();
                ...
                if (A != null) {
                    ...
                    if (e != null) {
                        ...
                        var B = e.filtervalue;
                        j.val(B);
                        f.jqxDropDownList({selectedIndex: E, animationType: x})
                    }
                    if (d != null) {
                        var D = o.indexOf(d.comparisonoperator);
                        var z = d.filtervalue;
                        h.val(z);
                        Q.jqxDropDownList({selectedIndex: D, animationType: x})
                    }
                    if (A.getoperatorat(0) == undefined) {
                        m.jqxDropDownList({selectedIndex: 0, animationType: x})
                    } else {
            ...
            this._hasdatefilter = true;
            var k = a("<div style='margin-top:3px;' class='filter'><input placeholder='Значення фільтра' autocomplete='off' class='filtertext1" + z.element.id + "' style='padding: 3px; height: 16px; margin-top: 3px; margin-bottom: 3px;' type='text'></input></div>");
            var m = k.find("input");
            m.addClass(this.toThemeProperty("jqx-input"));
            m.addClass(this.toThemeProperty("jqx-filter-input jqx-widget-content"));
            m.addClass(this.toThemeProperty("jqx-rc-all"));
            m.width(p - 18);
            var l = a("<div style='margin-top:3px;' class='filter'><input placeholder='Значення фільтра' autocomplete='off' class='filtertext2" + z.element.id + "' style='padding: 3px; height: 16px; margin-top: 3px;' type='text'></input></div>");
            var j = l.find("input");
            j.addClass(this.toThemeProperty("jqx-input"));
            j.addClass(this.toThemeProperty("jqx-filter-input jqx-widget-content"));
            j.addClass(this.toThemeProperty("jqx-rc-all"));
