        ...
        <div class="card m-2 mt-0">
            <div class="card-header border-bottom row mx-0">
                <div class=" d-flex justify-content-between align-items-center px-0">
                    <h4 class="card-title col-9 fw-semibold">Локації</h4> <a class="btn btn-primary"
                                                                            href="{{route('warehouse.create')}}"> <i
                            data-feather="plus" class="mr-1"></i> Додати локацію</a>
                </div>
            </div>
    ...
    @else
        <div style="margin-top: 253px">
            ...
            <div class="empty-company-title empty-company-title-m text-center">
                Додайте нову локацію
            </div>
            <div class="text-center mt-2">
                <a class="btn btn-primary" href="{{route('warehouse.create')}}">
                    <img class="plus-icon" src="{{asset('assets/icons/plus.svg')}}">Додати локацію
                </a>
            </div>
        </div>
    @endif
