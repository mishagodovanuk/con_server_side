...
@section('table-js')
    ...
    <script type="text/javascript">
        ...
        let baseUrl = window.location.origin + '/match/consolidation/filter?type='
        ...
        <div class="row d-flex">
            ...
            <div class="col-10 col-sm-10 col-md-10 col-lg-10 col-xxl-10 px-0">
                <div class="tab-content pb-0">
                    @include('match.dispatcher.content.created', ['breadcrumb_label' => __('localization.created_link')])
                </div>
            </div>
        </div>
    </div>
