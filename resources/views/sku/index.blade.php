    ...
    @if(count($goods))
        <div class="card m-2 mt-0">
            <div class="card-header border-bottom row mx-0 gap-1">
                <h4 class="card-title col-auto fw-bolder">Товари</h4>
                <div class="col-auto d-flex  flex-grow-1 justify-content-end pe-0">
                    <a class="btn btn-green" href="{{route('sku.create')}}">
            ...
            <div class="card-grid" style="position: relative;">
                ...
                <div class="table-block" id="sku-table">
    ...
    @else
        <div style="margin-top: 253px">
            ...
            <div class="empty-company-title empty-company-title-m text-center">
                Щойно товар буде створений він буде відображатися тут
            </div>
            <div class="text-center mt-2">
                <a class="btn btn-primary" href="{{route('sku.create')}}">
                    <img class="plus-icon" src="{{asset('assets/icons/plus.svg')}}">Створити товар
                </a>
            </div>
        </div>
    @endif
