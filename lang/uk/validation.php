...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'health_book' => [
            'required_if' => "Документ санітарної книжки є обов'язковим для посади водія"
        ],
        'driving_license' => [
            'required_if' => "Документ посвідчення водія є обов'язковим для посади водія"
        ],
        'health_book_number' => [
            'required_if' => "Поле номер особової медичної книжки є обов'язковим для заповнення для посади водія"
        ],
        'driving_license_number' => [
            'required_if' => "Поле номер посвідчення водія є обов'язковим для посади водія"
        ],
    ],
