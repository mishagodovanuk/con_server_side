    ...
    <div class="container-fluid px-2">
        ...
        <div class="d-flex justify-content-between flex-column  flex-sm-column flex-md-row flex-lg-row flex-xxl-row">
            <div class=" pb-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-slash">
                        ...
                        <li class="breadcrumb-item"><a href="/services/{{$service->id}}" style="color: #4B465C;">Перегляд
                                послуги {{$service->name}}</a></li>
                        <li class="breadcrumb-item fw-bolder active" aria-current="page">
                            Редагування послуги {{$service->name}}
                        </li>
            ...
            <div class="container_btn-createTP">
                <button type='button' class="btn   border-0" tabindex="4" id="edit-save-as-draft-button"> <span
        ...
        <div class="card p-2 pb-4">
            ...
            <div class="row  pb-4">
                ...
                <div class="col-12 col-sm-6 mb-1">
                    ...
                    <select class="select2 form-select" id="select-service-category" data-id="{{$service->category_id}}" data-dictionary="service_category"
                ...
                <textarea class="form-control " id="exampleFormControlTextarea1" rows="3"
                          placeholder="Коментар">{{$service->comment}}</textarea>
                </div>
