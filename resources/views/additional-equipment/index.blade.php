...
@section('title','Додаткове обладнання')
@section('page-style')
@endsection
...
@section('table-js')
    ...
    <script type="module" src="{{asset('assets/js/grid/transport/additional-equipment-table.js')}}"></script>
@endsection
    ...
    @if(count($additionalEquipments))
        ...
        <div class="card m-2">
            <div class="card-header border-bottom row mx-0 gap-1">
                <h4 class="card-title col-auto fw-bolder">Додаткове обладнання</h4>
                <div class="col-auto d-flex  flex-grow-1 justify-content-end pe-0">
                    <a class="btn btn-green" href="{{route('transport-equipment.create')}}">
            ...
            <div class="card-grid" style="position: relative;">
                ...
                <div class="table-block" id="additional-equipment-table">
    ...
    @else
        <div style="margin-top: 253px">
            <div class="empty-company text-center">
                У вас ще немає жодного додаткового обладнання!
            </div>
            <div class="empty-company-title empty-company-title-m text-center">
                Як тільки додаткове обладнання буде додано воно буде відображатися тут
            </div>
            <div class="text-center mt-2">
                <a class="btn btn-primary" href="{{route('transport-equipment.create')}}">
                    <img class="plus-icon" src="{{asset('assets/icons/plus.svg')}}">Додати обладнання
                </a>
            </div>
        </div>
    @endif
