...
@section('content')
    <div class="container-fluid find-company" id="find-company">
        <div class="card mb-0">
                                ...
                                <ul class="nav navbar-nav navbar-brand">
                                    <li class="nav-item  d-flex">
                                        <div class=" align-self-center px-0">
                                            <img width=25px" src="{{asset('assets/icons/nav-logo-consolid.svg')}}">
                                        </div>
    ...
    <div class="container-fluid d-none create-company" id="create-company">
        <div class="card mb-0">
            <div class="row mx-0" style="height: 851px">
                <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8 px-2 py-3">
                    <div class="row mx-0 h-100 justify-content-between flex-column">
        ...
        <span class="f-15 fw-6">
          Юридична особа
                                ...
                                <label class="form-label" for="select2-hide-search">Категорія компанії</label>
                                    <select class="hide-search form-select" data-dictionary="company_category"  id="category" data-placeholder="Вкажіть категорію вашої компанії">
                                        <option value=""></option>
                                                ...
                                                <div class="col-12 col-sm-6 mb-1">
                                                    <div class="mb-1">
                                                        ...
                                                        <select class="select2 form-select" id="country"
                                                                id="select2-hide-search" data-dictionary="country"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-12 mb-1">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <button
                                                            ...
                                                            disabled id="reg_doc-reset" type="button"><i
                                                ...
                                                <div class="col-12 col-sm-12 mb-1">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <button
                                                            class="btn btn-outline-primary input-group-btn disabled-btn-c"
                                                            disabled id="ust_doc-reset" type="button"><i
                                                                data-feather="x"></i></button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-body px-0 pb-0">
                                            <div class="row">
                                                <div class="col-12 mb-1">
                                                    <input class="form-check-input" type="checkbox" id="matchingAddress"
                                                           value="unchecked"/>
                                                    <label class="form-check-label" for="matchingAddress">Співпадає з
                                                        фактичною адресою</label>
                                                </div>
                                                <div class="col-12 col-sm-6 mb-1">
                                                    <div class="mb-1">
                                                        <label class="form-label" for="u_country">Країна</label>
                                                        <select class="select2 form-select" id="u_country"
                                                                data-placeholder="Виберіть країну" data-dictionary="country">
                                                            <option value=""></option>
    ...
    <div class="container-fluid d-none create-workspace" id="create-workspace">
        <div class="card mb-0">
            <div class="row mx-0" style="height: 851px">
                <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8 px-2 py-3">
                    <div class="row mx-0 h-100 justify-content-between flex-column">
                                                ...
                                                <div class="row mx-0">
                                                    <div class="col-auto p-0">
                                                        <div class="p-2"
                                                            ...
                                                            <img src="{{asset('assets/icons/building-community.svg')}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-9 py-1 flex-grow-1">
                                                        ...
                                                        <div class="d-flex align-items-center "
                                                            ...
                                                            <p class="fw-bold mb-0">{{Auth::user()->surname.' '.mb_strtoupper(mb_substr(Auth::user()->name,0,1))
                                                            .'.'.mb_strtoupper(mb_substr(Auth::user()->patronymic,0,1))}}</p>
                                                        </div>
    ...
    <div class="container-fluid d-none send-join" id="send-join">
        <div class="card mb-0">
            <div class="row mx-0" style="height: 851px">
                <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8 px-2 py-3">
                    <div class="row mx-0 h-100 justify-content-between flex-column">
