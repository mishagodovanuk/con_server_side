...
@section('table-js')
    ...
    <script>let cargoRequestId = null;</script>
    <script type="module" src="{{asset('assets/js/grid/match/dispatcher/reverse-loading/cargo-request-table.js')}}"></script>
    <script type="module" src="{{asset('assets/js/grid/match/dispatcher/reverse-loading/transport_planning_table.js')}}"></script>
        ...
        <div class="row d-flex">
            ...
            <div class="col-10 col-sm-10 col-md-10 col-lg-10 col-xxl-10 px-0">
                <div class="tab-content pb-0">
                    @include('match.dispatcher.content.reverse-loading')
                </div>
            </div>
        </div>
    </div>
...
@section('page-script')
    ...
    <script type="module" src="{{asset('assets/js/entity/match/match-rv-loading.js')}}"></script>


    <script type="module">
        import {tableSetting} from '{{asset('assets/js/grid/components/table-setting.js')}}';

        tableSetting($('#rv-transport-planning-table'));
    </script>
    <script type="module">
        import {offCanvasByBorder} from '{{asset('assets/js/utils/offCanvasByBorder.js')}}';

        offCanvasByBorder($('#rv-transport-planning-table'));
    </script>

    <script type="module">
        import {tableSetting} from '{{asset('assets/js/grid/components/table-setting.js')}}';

        tableSetting($('#rv-all-table'), '-6');
    </script>
    <script type="module">
        import {offCanvasByBorder} from '{{asset('assets/js/utils/offCanvasByBorder.js')}}';

        offCanvasByBorder($('#rv-all-table'), '-6');
    </script>
@endsection
