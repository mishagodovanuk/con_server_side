...
@section('table-js')
    ...
    <script type="text/javascript">
        ...
        var addButton = $(
            '<li class="btn-tabs-watch-all" style="margin-left: auto ">  <div id="change-button-for-tabs"> <a data-bs-toggle="modal" id="button_paking" data-bs-target="#add_paking" href="#" class="btn btn-outline-primary" >   <i data-feather="plus" class="me-25"></i> <span>Додати пакування</span></a> <a style="display: none;" id="button_bar_code" href="#" data-bs-toggle="modal" data-bs-target="#add_bar_code" class="btn btn-flat-primary">Додати штрих-код </a> </div></li>'
        );
    ...
    <div class="mx-0 px-2 ">
        ...
        <div class="d-flex align-items-center flex-column flex-lg-row justify-content-between pb-2">
            <div class="tn-details-breadcrumbs-nav align-self-start">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-slash">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="{{"/sku/".$sku->id}}"
                                                                           style="color: #4B465C;">Перегляд
                                товару {{$sku->name}}</a></li>
            ...
            <div class="tn-details-actions d-flex gap-1 align-self-end ">
                ...
                <button type="submit" id="edit" data-id="{{$sku->id}}" class="btn btn-green">
                    Зберегти
                </button>
            </div>
        </div>

        <form action="{{route('sku.update',['sku'=>$sku->id])}}" method="post">
            @method('PUT')
            @csrf
                        ...
                        <div class="card-body p-0 mt-1">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 mb-1">
                                    ...
                                    <input type="text" class="form-control" value="{{ $sku->name }}" id="name_sku"
                                ...
                                <div class="col-12 col-md-6 mb-1">
                                    ...
                                    <select class="select2 form-select" name="category_id" id="company_owner"
                                            data-id="{{$sku->company_id}}" data-dictionary="company"
                                ...
                                <div class="col-12 col-md-6 mb-1">
                                    ...
                                    <select class="select2 form-select" name="cargo_type_id"
                                            id="cargo_type" data-dictionary="cargo_type"
                                            data-id="{{$sku->category_id}}"
                                            data-placeholder="Виберіть товару">
                                        <option value=""></option>
                                    </select>
                                </div>

                                <div class="col-12 col-md-6 mb-1">
                                    <label class="form-label" for="category_sku">Категорія</label>
                                    <select class="select2 form-select" name="category_id" id="category_sku"
                                            data-id="{{$sku->category_id}}" data-dictionary="goods_category"
                                ...
                                <div class="col-12 col-md-6 mb-1">
                                    <label class="form-label" for="producer">Виробник</label>
                                    <select class="select2 form-select" name="category_id" id="producer"
                                            data-id="{{$sku->manufacturer_id}}" data-dictionary="company"
                                ...
                                <div class="col-12 col-md-6 mb-1">
                                    <label class="form-label" for="producerСountry">Країна
                                        виробник</label>
                                    <select class="select2 form-select" name="category_id" id="producerСountry"
                                            data-id="{{$sku->manufacturer_country_id}}" data-dictionary="country"
                                ...
                                <div class="col-12 col-md-6 mb-1">
                                    ...
                                    <select class="select2 form-select" name="category_id" id="adr"
                                            data-id="{{$sku->adr_id}}" data-dictionary="adr"
                                ...
                                <div class="col-12 col-md-6 mb-1">
                                    <label class="form-label" for="unit_sku ">Одиниця виміру</label>
                                    <select class="select2 form-select" name="measurement_unit_id" id="unit_sku"
                                            data-id="{{$sku->measurement_unit_id}}" data-dictionary="measurement_unit"
                                ...
                                <textarea class="form-control" id="comment_goods" rows="2"
                                    placeholder="Коментар">{{$sku->comment}}</textarea>
                            </div>
                                            ...
                                            <div class="d-flex gap-1">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="from"
                                                           ...
                                                           placeholder="Від 00.0" value="{{$sku->temp_from}}"
                                                           id="temperature_regime_from">
                                                    <span class="input-group-text fw-light">&#8451;</span>
                                                </div>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="to"
                                                           oninput="maskFractionalNumbers(this,3)"
                                                           placeholder="До 00.0" value="{{$sku->temp_to}}"
                                                           id="temperature_regime_to">
                                                    <span class="input-group-text fw-light">&#8451;</span>
                                                </div>
                                ...
                                <div class="col-12 col-md-6 mb-1 d-flex flex-grow gap-1">
                                    <div class="w-100"><label class="form-label">Висота</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="weight"
                                                   ...
                                                   placeholder="000.0" value="{{$sku->height}}" id="sku_height">
                                    ...
                                    <div class="w-100"><label class="form-label">Ширина</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="weight"
                                                   oninput="maskFractionalNumbers(this,4)"
                                                   placeholder="000.0" value="{{$sku->width}}" id="sku_width">
                                            <span class="input-group-text">см</span>
                                        </div>
                                    </div>
                                    <div class="w-100"><label class="form-label">Довжина</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="weight"
                                                   oninput="maskFractionalNumbers(this,4)"
                                                   placeholder="000.0" value="{{$sku->depth}}" id="sku_length">
                                            <span class="input-group-text">см</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <form class="row mx-0 js-modal-form" id="modal-packing-form">
                                        <div class="col-12 mb-2">
                                            ...
                                            <select name="type_id" class="select2 form-select"
                                                    id="add_paking_name" data-dictionary="package_type" data-placeholder="Виберіть тип пакування">
                                                <option value=""></option>
                                            </select>
                                        </div>
                                ...
                                <form id="update-package " class="row mx-0 js-modal-form2">
                                    <div class="col-12 mb-2">
                                        <label class="form-label" for="edit_paking_name select2-hide-search">Тип
                                            пакування</label>
                                        <select class="select2 form-select hide-search" id="edit_paking_name" data-dictionary="package_type"
                                    ...
                                    <div class="col-md-6 col-sm-12 mb-2">
                                        <label class="form-label">К-сть
                                            одиниць в пакуванні</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="edit_quantity_packing" oninput="maskFractionalNumbers(this,4)"
                                                placeholder="00">
                                                <span class="input-group-text">м <sup>2</sup></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-sm-12 mb-2">
                                        <label class="form-label">Маса пакування</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="edit_weight_packing" oninput="maskFractionalNumbers(this,5)"
                                                value="{{old('weight')}}" placeholder="Вкажіть масу">
                                            <span class="input-group-text">кг</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-sm-12 mb-2">
                                        <label class="form-label">Маса нетто</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="edit_net_weight" oninput="maskFractionalNumbers(this,7)"
                                                placeholder="00">
                                            <span class="input-group-text">кг</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-sm-12 mb-2">
                                        <label class="form-label">Маса брутто</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="edit_gross_weight" oninput="maskFractionalNumbers(this,7)"
                                    ...
                                    <div class="col-12  mb-2 d-flex gap-1">
                                        <div class=""> <label class="form-label">Висота</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="edit_size_height"  oninput="maskFractionalNumbers(this,4)"
                                                    placeholder="000.0">
                                                <span class="input-group-text">см</span>
                                            </div>
                                        </div>
                                        <div class=""> <label class="form-label">Ширина</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="edit_size_width" oninput="maskFractionalNumbers(this,4)"
                                                    placeholder="000.0">
                                                <span class="input-group-text">см</span>
                                            </div>
                                        </div>
                                        <div class=""> <label class="form-label">Довжина</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="edit_size_depth" oninput="maskFractionalNumbers(this,4)"
                                                    placeholder="000.0">
                                                <span class="input-group-text">см</span>
                                            </div>
                                        </div>
                            ...
                            <div class="card-body px-4 pb-4">
                                <form id="barcode-form" class="row mx-0">
                                    ...
                                    <div class="col-12 mb-2">
                                        ...
                                        <input type="number" class="form-control" id="add_bar_code_input" name="barcode"
                                    ...
                                    <div class="col-12 mt-1">
                                        <div class="d-flex float-end">
                                            ...
                                            <button type="button" class="btn btn-primary" id="create_barcode">Зберегти
                                            </button>
                                        </div>
                                    </div>
...
<script>
    ...
    <script type="module">
        ...
        <option value="{{$package->id}}"
                {{ old('category_id')==$package->id ? 'selected': '' }}>{{$package->name}}
        </option>
        @endforeach
