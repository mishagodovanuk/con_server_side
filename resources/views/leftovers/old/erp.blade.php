...
@section('table-js')
    ...
    <script type="module" src="{{asset('assets/js/grid/leftovers/leftovers-erp-table.js')}}"></script>
@endsection
    ...
    @if(True)
        <div class="card m-2">
            <div class="card-header border-bottom row mx-0">
                <h4 class="card-title col-9 fw-semibold">Залишки ERP</h4>
            </div>
            <div class="card-grid" style="position: relative;">
                ...
                <div class="table-block" id="leftoversERPDataTable">
    ...
    @else
        <div style="margin-top: 253px">
            <div class="empty-company text-center">
                У вас ще немає жодного документу!
            </div>
...
@section('page-script')
    <script type="module">
        ...
        tableSetting($('#leftoversERPDataTable'));

    </script>
    <script type="module">
        import {offCanvasByBorder} from '{{asset('assets/js/utils/offCanvasByBorder.js')}}';

        offCanvasByBorder($('#leftoversERPDataTable'));
