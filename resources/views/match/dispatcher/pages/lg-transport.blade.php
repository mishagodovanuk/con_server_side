    ...
    <div class="container-fluid px-3">
        <div class="row d-flex">
            ...
            <div class="tab-content pb-0">
             @include('match.dispatcher.content.pre-match', ['wizard_step_1' => __('localization.lgtransport_choose_trip'), 'wizard_step_2' => __('localization.lgtransport_choose_tn'), 'breadcrumb_label' => __('localization.lgtransport_back_to_lg_transport')])
             </div>
            </div>
        </div>
    </div>
