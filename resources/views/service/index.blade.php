...
@section('page-style')
    @section('before-style')
        ...
        <link rel="stylesheet" href="{{asset('assets/libs/jqwidget/jqwidgets/styles/jqx.light-wms.css')}}"
              type="text/css"/>
    @endsection
            ...
            <div class="card m-2 mt-0">
                <div class="card-header border-bottom row mx-0">
                    <div class=" d-flex justify-content-between align-items-center">
                        <h4 class="card-title col-9 fw-semibold">Послуги </h4> <a class="btn btn-primary"
                                                                                  href="/services/create"> <i
                                data-feather="plus" class="mr-1"></i> Додати послугу</a>
                    </div>
                </div>
                <div class="card-grid" style="position: relative;">
                    ...
                    <div class="table-block" id="services-table">
        ...
        @else
            <div style="margin-top: 253px">
                ...
                <div class="empty-company-title text-center">
                    Щойно послуга буде створена вона буде відображатися тут
                </div>
                <div class="text-center mt-2">
                    <a class="btn btn-primary" href="{{route('services.create')}}">
                        <img class="plus-icon" src="{{asset('assets/icons/plus.svg')}}">Створити
                        послугу
                    </a>
                </div>
            </div>
