...
export function markupModalTnToAction(item,dataActions) {
 ...
 ${getLocalizedText("adding_cn_to_step")}</h2>
                    ...
                    <div class="d-flex flex-column  mb-1 border rounded p-1" style="background-color:#F8F8F9">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex">
                                <span class="alert-${action.loading.length === 0 ? 'danger' : ( !isSequenceValid(id, 'loading') ? 'primary'  : 'success')} rounded" style="padding:8px 9px;margin-right:8px">
                                    <img src="${url}/assets/icons/direction-flight-${action.loading.length === 0 ? 'danger' : ( !isSequenceValid(id, 'loading') ? 'primary'  : 'success')}.svg" alt="drag-drop"></span>
                                ...
                                <span class="alert-${action.unloading.length === 0 ? 'danger' : ( !isSequenceValid(id, 'unloading') ? 'primary'  : 'success')} rounded" style="padding:8px 9px;margin-right:8px">
                                    ...
                                    src="${url}/assets/icons/direction-flight-${action.unloading.length === 0 ? 'danger' : ( !isSequenceValid(id, 'unloading') ? 'primary'  : 'success')}.svg" alt="drag-drop"></span>
                        ...
                        <div class="d-flex gap-1">
                            ...
                            <div class="d-flex"><img src="${url}/assets/icons/timeline3.svg" alt=""></div>
                            <div class="d-flex flex-column justify-content-between">
