            ...
            <div class="" id="body-wrapper">
                ...
                <div
                    ...
                    <label class="form-check-label f-15"
                        for="changeFonts">{{__('localization.created_table_bigger_font')}}</label>
                ...
                <div
                    class="mt-1 d-flex flex-row align-items-center justify-content-between px-2">
                    <label class="form-check-label f-15"
                        for="changeCol">{{__('localization.created_table_change_column')}}</label>
                    <div class="form-check form-check-warning form-switch">
                        <input type="checkbox" class="form-check-input checkbox"
                            id="changeCol" />
                    </div>
...
<div class="table-block" id="created-consolidation-table">
</div>
</div>