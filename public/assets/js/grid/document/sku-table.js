...
$(document).ready(function () {
    ...
    var grid = table.jqxGrid(
        {
            ...
            rendertoolbar: function (statusbar) {
                return toolbarRendererSku(statusbar, table, true, 1, fieldData['listSourceArray'].length + 1);
            },
            columns: [
                {
                    minwidth: "50",
    ...
    let listSource = [
        ...
        {label: 'Назва', value: 'id', checked: true},
        {label: "Кількість", value: 'number',checked: true},
        ...fieldData['listSourceArray']
