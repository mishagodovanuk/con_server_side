        ...
        @if($companies)
            ...
            <div class="card m-2 mt-0">
                <div class="card-header border-bottom row mx-0 gap-1">
                    <h4 class="card-title col-auto fw-bolder">Компанії</h4>
                    <div class="col-auto d-flex  flex-grow-1 justify-content-end pe-0">
                        <a class="btn btn-green" href="{{route('company.create')}}">
            ...
            <div style="margin-top: 187px">
                ...
                <div class="text-center mt-2">
                    <a class="btn btn-primary" href="{{route('company.create')}}">
                        <img class="plus-icon" src="{{asset('assets/icons/plus.svg')}}" alt="plus">Додати
                        компанію
                    </a>
                </div>
            </div>
