...
@section('table-js')
    ...
    <script type="module" src="{{asset('assets/js/grid/residue-control/residue-control-view-table.js')}}"></script>
@endsection
    ...
    <div class="px-2">
            ...
            <div class=" pb-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-slash">
                        <li class="breadcrumb-item"><a class="link-secondary" href="/residue-control">Контроль
                                залишків</a></li>
                        <li class="breadcrumb-item fw-bolder active" aria-current="page">
                            Перелік ТН з товаром
                            “Крекер "Вершковий "Yarych" 3.78 кг 21*180 г”
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card my-2 mt-0">
            <div class="d-flex card-header border-bottom mx-0 px-2 gap-1">
                <div class="d-flex">
                    <h4 class="card-title fw-bolder">Перелік ТН з товаром “Крекер "Вершковий "Yarych" 3.78 кг 21*180
                        г”</h4>
                </div>
            ...
            <div class="card-grid" style="position: relative;">
                ...
                <div class="table-block" id="residue-control-view-table">
