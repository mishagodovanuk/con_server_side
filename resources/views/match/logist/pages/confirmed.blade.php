...
@section('table-js')
    ...
    <script type="text/javascript">
     let baseUrl = window.location.origin + '/match/consolidation/filter?status=approved&type='
        ...
        @include('match.logist.layout.nav')
            <div class="col-12 col-sm-12 col-md-10 col-lg-10 col-xxl-10 px-0 h-100">
                <div class="tab-content pb-0 h-100">
                    @include('match.logist.content.confirmed')
...
var dataActions =[
    ...
    <script type="module" src="{{asset('assets/js/entity/match/logist/confirmed.js')}}"></script>
