    ...
    @if(count($contracts))
        <div class="card m-2">
            <div class="card-header border-bottom row mx-0 gap-1">
                <h4 class="card-title col-auto fw-bolder">Договори</h4>
            ...
            <div class="card-grid" style="position: relative;">
                ...
                <div class="table-block" id="contract-table">
    ...
    @else
        <div style="margin-top: 253px">
            <div class="empty-company text-center">
                У вас ще немає жодних договорів!
            </div>
            <div class="empty-company-title text-center">
                Для продовження роботи додайте новий договір
            </div>
