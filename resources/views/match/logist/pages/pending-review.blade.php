...
@section('table-js')
 ...
 let baseUrl = window.location.origin + '/match/consolidation/filter?status=review&type='
        ...
        @include('match.logist.layout.nav')
            <div class="col-12 col-sm-12 col-md-10 col-lg-10 col-xxl-10 px-0 h-100">
                <div class="tab-content pb-0 h-100">
                    @include('match.logist.content.view-review&rejected', ['breadcrumb_label' => __('local_logist.logist_cab_pending_review')])
                </div>
            </div>
        </div>
    </div>
