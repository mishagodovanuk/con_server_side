...
@section('title','Редагування контракту')
@section('page-style')
@endsection
            ...
            <div class="">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-slash">
                        ...
                        <li class="breadcrumb-item fw-bolder active" aria-current="page">Редагування договору
                            №{{$contract->id}}
                        </li>
                    </ol>
                </nav>
        ...
        <div class="row mx-0 mt-2 ">
            <div class="col-12 col-md-12 col-lg-5 pe-0 ps-0">
                <div class="card p-2 mb-1">
                    <h4 class="card-title fw-bolder pt-0 ">Договір №{{$contract->id}}</h4>
                    <div class="row mb-1">
                        <div class="col-7">
                            ...
                            <select class="select2 form-select" name="typeContract" id="typeContract"
                                ...
                                <option value=""></option>
                                <option
                                    {{$contract->type_id === 0  ? 'selected' : '' }} value="0">
                                    Договір на торгові послуги
                                </option>
                                <option
                                    {{$contract->type_id === 1  ? 'selected' : '' }} value="1">
                                    Договір на складські послуги
                                </option>
                                <option
                                    {{$contract->type_id === 2  ? 'selected' : '' }} value="2">
                                    Договір на транспортні послуги
                                </option>
                        ...
                        <div class="col-5 ps-0">
                            ...
                            <select class="select2 form-select" name="side" id="side" data-placeholder="Замовник">
                                <option value=""></option>
                                <option
                                    {{$contract->role === 0  ? 'selected' : '' }} value="0">
                                    Замовник
                                </option>
                                <option
                                    {{$contract->role === 1  ? 'selected' : '' }} value="1">
                                    Постачальник
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="mb-1">
                        ...
                        <select class="select2 form-select" name="yourCompany" id="yourCompany"
                            ...
                            @foreach($companies as $company)
                                <option
                                    {{$company->id === $contract->company_id ? 'selected': ''}} value="{{$company->id}}">{{$company->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-1">
                        ...
                        <select class="select2 form-select" name="contractor" id="contractor"
                            ...
                            @foreach($companies as $company)
                                <option
                                    {{$company->id === $contract->counterparty->id ? 'selected': ''}} value="{{$company->id}}">{{$company->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-1 position-relative">
                        ...
                        <input type="text" id="validityPeriod" class="form-control flatpickr-basic flatpickr-input"
                               required
                               placeholder="Вкажіть дату закінчення договору" name="group"
                    ...
                    <div class="form-check form-switch mb-1">
                        <input type="checkbox" class="form-check-input"
                               {{$contract->signed_at !== null ? 'checked' : ""}}   id="contractSigned"/>
                    ...
                    <div class="mb-1 position-relative">
                        ...
                        <input type="text" id="dateSigningContract" class="form-control flatpickr-basic flatpickr-input"
                               required placeholder="Вкажіть дату підписання договору" name="group"
                               value="{{$contract->signed_at}}" readonly="readonly">
                        <span class="cursor-pointer text-secondary position-absolute top-50"
                              style="right : 27px;pointer-events: none;"><i data-feather="calendar"></i></span>
                    </div>
                    <div class="">
                                ...
                                <div class="p-2 pb-0 mb-2">
                                    <h2 class="f-15 fw-bolder mb-1">
                                        <span id="retail-list-regulations-type-text">
                                            ...
                                            {{$contract->type_id === 2  ? 'Транспорті' : '' }}
                                        </span> регламенти
                                        (<span
                                            id="retail-list-regulations-side">{{$contract->role === 0  ? 'Замовник' : 'Постачальник' }}</span>)
                                    </h2>
