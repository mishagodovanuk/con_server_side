...
(function (window, document, $) {
    ...
    // TODO рядок 417, ламаний і весь код не працює тому там !==
    ...
    if ($body.attr('data-framework') !== 'laravel') {
        ...
        i18next.use(window.i18nextXHRBackend).init(
            {
                ...
                fallbackLng: 'en',
                backend: {
                    loadPath: assetPath + 'assets/data/locales/{{lng}}.json'
                },
                returnObjects: true
            },
            function (err, t) {
        ...
        $('.dropdown-language .dropdown-item').on('click', function () {
            ...
            if (currentLanguage === 'ua') {
                $('#dropdown-flag .selected-language').attr('data-i18n', 'LangTitleUA');
            } else if (currentLanguage === 'en') {
                $('#dropdown-flag .selected-language').attr('data-i18n', 'LangTitleEN');
            } else if (currentLanguage === 'de') {
                $('#dropdown-flag .selected-language').attr('data-i18n', 'LangTitleGE');
            } else if (currentLanguage === 'pl') {
                $('#dropdown-flag .selected-language').attr('data-i18n', 'LangTitlePL');
            }
        ...
        const {origin,pathname}= window.location;
            const result=  currentLanguage === 'ua' ? (!pathname.includes('/uk') ?  origin+'/uk'+pathname :origin+pathname) :  origin+pathname.replace('/uk','');
