...
@section('table-js')
    ...
    <script type="module" src="{{asset('assets/js/grid/transport/transport-table.js')}}"></script>
@endsection
...
@if(count($transports))
        <div class="card m-2 mt-0">
            <div class="card-header border-bottom row mx-0 gap-1">
                <h4 class="card-title col-auto fw-semibold">Транспорт </h4>
            ...
            <div class="card-grid" style="position: relative;">
                ...
                <div class="table-block" id="transport-table">
    ...
    @else
        <div style="margin-top: 253px">
            <div class="empty-company text-center">
                У вас ще немає жодного транспорту!
            </div>
            <div class="empty-company-title empty-company-title-m text-center">
                Як тільки транспорт буде додано він буде відображатися тут
            </div>
            <div class="text-center mt-2">
                <a class="btn btn-primary" href="{{route('transport.create')}}">
                    <img class="plus-icon" src="{{asset('assets/icons/plus.svg')}}">Додати транспорт
                </a>
            </div>
        </div>
    @endif
