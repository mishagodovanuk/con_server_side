...
@section('content')
    ...
    <div class=" mx-2 px-0">
        <div class="row mx-0" style="column-gap:24px;">
            ...
            <div class="col-12 col-lg-7 px-0 order-1 order-lg-0" style="flex-grow: 1">
                <div class="px-0">
                        ...
                        <div class="card-body p-0 pb-2">
                            <div class="row">
                                <div class="col-12 mt-1">
                                    ...
                                    <div class="d-flex flex-wrap flex-lg-row justify-content-between gap-1">
            ...
            <div class="col-lg-4 px-0 order-0 order-lg-1" style="flex-grow: 1;">
                <div class="card  pt-1 pb-2">
                    <div class="card-header pt-50 px-2">
                        <h4 class="card-title fw-bolder">{{$document->documentType->settings()['header_name']}}</h4>
                    </div>
                    ...
                    @for($i=0;$i<count(json_decode($document->documentType->settings,true)['custom_blocks']);$i++)
                        <hr>
                        <div class="card-header px-0 pt-50">
                            <h4 class="card-title fw-bolder px-2">{{$document->documentType->settings()['block_names'][$i]}}</h4>
                        </div>
                        <div class="card-body pb-0 px-0">
                            <div class="row mx-0" style="row-gap: 1rem">
                                <div class="col-12 ps-50 ">
