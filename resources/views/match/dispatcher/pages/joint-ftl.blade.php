    ...
    <div class="container-fluid px-3">
        <div class="row d-flex">
            ...
            <div class="tab-content pb-0">
             @include('match.dispatcher.content.pre-match', ['wizard_step_1' => __('localization.com_ftl_choose_trip'), 'wizard_step_2' => __('localization.com_ftl_choose_tn_for_upload'), 'breadcrumb_label' => __('localization.dispatcher_common_ftl')])
             </div>
            </div>
        </div>
    </div>
